...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '3675_main_landing_v0');
      ...
      <div className={appSt.container}>
        <div className={appSt.box}>
          ...
          <Typography.Text view="primary-medium" color="secondary">
            Первый месяц — бесплатно, дальше 299 ₽ в месяц
          </Typography.Text>
        </div>
        ...
        <div className={appSt.subscription}>
          ...
          <Typography.Text view="primary-medium" className={appSt.subscriptionText}>
            Подписка стоит 299 ₽, если тратите с карты от 20 000 ₽ в месяц. Если тратите меньше — 399 ₽
          </Typography.Text>
        </div>
